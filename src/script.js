  ...
  _createClass(VideoPlayer, [{
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            ...
            //если нет, то создаем     
            var path = btn.getAttribute('data-url'); //data-url указана ссылка на видео

            _this.createPlayer(path); //при нажатии на кнопку создается плеер с ссылкой на видео  
    ...
    value: function createPlayer(url) {
      this.player = new YT.Player('frame', {
        ...
        height: '100%',
        width: '100%',
        videoId: "".concat(url) //будет динамически подк. из аргумента этого метода
    ...
    key: "init",
    value: function init() {
      //самый главный метод, где отражаются остальные    
...
function (_Slider) {
  ...
  //наследует(extends) от  Slider
  function MainSlider(btns) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns)); //super - получаем св-ва btns от родителя   
  }
      ...
      try {
        ...
        this.btns.forEach(function (btn) {
          ...
          btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
            ...
            _this2.showSlides(_this2.slideIndex); //показ текущего слайда
